...
String farsiNumbers(String input) {
  String updatedInput;
  updatedInput = input.replaceAll('0', '۰');
  updatedInput = updatedInput.replaceAll('1', '۱');
  updatedInput = updatedInput.replaceAll('2', '۲');
  updatedInput = updatedInput.replaceAll('3', '۳');
  updatedInput = updatedInput.replaceAll('4', '۴');
  updatedInput = updatedInput.replaceAll('5', '۵');
  updatedInput = updatedInput.replaceAll('6', '۶');
  updatedInput = updatedInput.replaceAll('7', '۷');
  updatedInput = updatedInput.replaceAll('8', '۸');
  updatedInput = updatedInput.replaceAll('9', '۹');
  return updatedInput;
}
...
String? englishNumbers(String? input) {
  String? updatedInput;
  if (input != null) {
    updatedInput = input.replaceAll('۰', '0');
    updatedInput = updatedInput.replaceAll('۱', '1');
    updatedInput = updatedInput.replaceAll('۲', '2');
    updatedInput = updatedInput.replaceAll('۳', '3');
    updatedInput = updatedInput.replaceAll('۴', '4');
    updatedInput = updatedInput.replaceAll('۵', '5');
    updatedInput = updatedInput.replaceAll('۶', '6');
    updatedInput = updatedInput.replaceAll('۷', '7');
    updatedInput = updatedInput.replaceAll('۸', '8');
    updatedInput = updatedInput.replaceAll('۹', '9');
  }
  return updatedInput;
}
...
String translate(String input, Jalaali date, bool farsiNum) {
  String updatedInput;
  updatedInput = input.replaceAll('YYYY', date.year.toString());
  updatedInput =
      updatedInput.replaceAll('YY', date.year.toString().substring(2, 4));
  updatedInput =
      updatedInput.replaceAll('MMMM', getJalaaliMonthName(date.month));
  updatedInput =
      updatedInput.replaceAll('MMM', getJalaaliMonthName(date.month));
  updatedInput =
      updatedInput.replaceAll('MM', date.month.toString().padLeft(2, '0'));
  updatedInput = updatedInput.replaceAll('M', date.month.toString());
//  updatedInput = updatedInput.replaceAll('DDD', _getPersianNumber(date.day));
  updatedInput =
      updatedInput.replaceAll('DD', date.day.toString().padLeft(2, '0'));
  updatedInput = updatedInput.replaceAll('D', date.day.toString());
  if (farsiNum) {
    updatedInput = farsiNumbers(updatedInput);
  }
  return updatedInput;
}
...
String translateStandardDateTime(String input, DateTime date) {
  ...
  updatedInput =
      updatedInput.replaceAll('YY', date.year.toString().substring(2, 4));
  updatedInput =
      updatedInput.replaceAll('MMMM', getGregorianMonthName(date.month));
  updatedInput =
      updatedInput.replaceAll('MMM', getGregorianMonthNameAbbr(date.month));
  updatedInput =
      updatedInput.replaceAll('MM', date.month.toString().padLeft(2, '0'));
  updatedInput = updatedInput.replaceAll('M', date.month.toString());
//  updatedInput = updatedInput.replaceAll('DDD', _getPersianNumber(date.day));
